        ...
        <div className="p-6">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <p className="text-xl font-semibold text-slate-900">{getDisplayName()}</p>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <form onSubmit={handleSubmit((d) => mutation.mutate(d))} className="p-6 space-y-5">
          ...
          <button 
            ...
            className={cn(
              'w-full inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold',
